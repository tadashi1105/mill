...
/**
 * --------------------------------------------------------------------------
 * Bootstrap (v4.0.0-alpha.2): drawer.js
...
const Drawer = (($) => {
  ...
  const ClassName = {
    SCROLLBAR_MEASURER : 'site-c-drawer-scrollbar-measure',
    BACKDROP           : 'site-c-drawer-backdrop',
    OPEN               : 'site-c-drawer-open',
    FADE               : 'fade',
    IN                 : 'in'
  }

  const Selector = {
    DIALOG             : '.site-c-drawer__dialog',
  ...
  class Drawer {
    ...
    hide(event) {
      ...
      if (Util.supportsTransitionEnd() &&
        ...
        $(this._element)
          .one(Util.TRANSITION_END, $.proxy(this._hideDrawer, this))
    ...
    _showElement(relatedTarget) {
      ...
      if (!this._element.parentNode ||
        ...
        // don't move drawer dom position
