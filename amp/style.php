...
.amp-wp-article aside *:last-child {
	margin-bottom: 0;
}

.amp-wp-after-article {
	color: #353535;
	font-weight: 400;
	margin: 1.5em auto;
	max-width: 840px;
...
.site-p-entry-list:hover {
	background-color: #f7f7f9;
}

.site-p-entry-list + .site-p-entry-list {
	border-top: 1px solid #dfdfdf;
}

.site-p-entry-list__object {
	width: 2.5rem;
	height: 2.5rem;
	border-radius: 50%;
}

.site-p-entry-list__title {
...
.site-p-entry-list__meta {
	font-size: 0.75rem;
	color: rgba(0, 0, 0, 0.5);
}

.site-p-entry-list__meta > span + span {
	margin-left: 0.2rem;
}
...
.site-c-media__cell--body {
	overflow: hidden;
	zoom: 1;
	width: 10000px;
}

.site-c-media__cell--left {
	padding-right: 0;
}

.site-c-media__object {
	display: block;
}
...
.site-c-btn--block + .site-c-btn--block {
  margin-top: 5px;
}